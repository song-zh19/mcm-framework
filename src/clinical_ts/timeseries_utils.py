    ...
    def _getitem(self, idx,start_idx_rel):
        ...
        if(self.mode=="files"):#from separate files
            ...
            if self.multi_modal_dim is None:
                ...
                modaldata = np.load(self.memmap_meta_filename.parent/'genEmbedding-qwen2_5'/original_filename)
                relevant_features = [21, 20, 27, 73, 74, 59, 84, 87, 92, 83, 93, 85, 57, 64, 90, 107, 63, 100, 75, 82]   # most relevant features
                # relevant_features = [20, 21, 27, 87, 84, 85, 83, 42, 51, 63, 44, 75, 45, 59, 92, 76, 93, 50, 66, 41]
                # relevant_features = [20, 16, 74, 21, 73, 27, 83, 59, 112, 127, 100, 92, 87, 115, 84, 93, 64, 57, 82, 55] # spearman
                # relevant_features = [20, 21, 16, 83, 84, 27, 87, 74, 51, 42, 63, 44, 127, 73, 75, 50, 126, 100, 112, 68]
                modaldata = modaldata[relevant_features[:5]]
