...
class LightningCPC(pl.LightningModule):
    ...
    def __init__(self, hparams):
        ...
        self.model_cpc = CPCModel(input_channels=self.hparams.input_channels, 
                                  strides=strides,
                                  kss=kss,
                                  features=features,
                                  ...
                                  lstm=not(self.hparams.gru),
                                  bias_proj=self.hparams.bias,
                                  num_classes=self.num_classes,
                                  skip_encoder=self.hparams.skip_encoder,
                                  bn_encoder=not(self.hparams.no_bn_encoder),
                                  lin_ftrs_head=[] if self.hparams.linear_eval else eval(self.hparams.lin_ftrs_head),
                                  ...
                                  train_head_only=True if (self.hparams.linear_eval or self.hparams.train_head_only) else False,
                                  multi_modal_dim=hparams.modal_dim if hparams.multi_modal else None)
